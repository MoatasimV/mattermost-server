...
func TestSuggestions(t *testing.T) {
	...
	assert.Equal(t, "Connect your TAKWEN DOaccount to your Jira account", suggestions[0].Description)
...
func createJiraAutocompleteData() *model.AutocompleteData {
	...
	connect := model.NewAutocompleteData("connect", "[url]", "Connect your TAKWEN DOaccount to your Jira account")
	jira.AddCommand(connect)

	disconnect := model.NewAutocompleteData("disconnect", "", "Disconnect your TAKWEN DOaccount from your Jira account")
	...
	install := model.NewAutocompleteData("install", "", "Connect TAKWEN DOto a Jira instance")
	...
	uninstall := model.NewAutocompleteData("uninstall", "", "Disconnect TAKWEN DOfrom a Jira instance")
