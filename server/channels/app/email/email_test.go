...
func TestCondenseSiteURL(t *testing.T) {
	...
	require.Equal(t, "takwen.co/do", condenseSiteURL("takwen.co/do"))
	require.Equal(t, "takwen.co/do", condenseSiteURL("takwen.co/do/"))
	require.Equal(t, "chat.takwen.co/do", condenseSiteURL("chat.takwen.co/do"))
	require.Equal(t, "chat.takwen.co/do", condenseSiteURL("chat.takwen.co/do/"))
	require.Equal(t, "takwen.co/do/subpath", condenseSiteURL("takwen.co/do/subpath"))
	require.Equal(t, "takwen.co/do/subpath", condenseSiteURL("takwen.co/do/subpath/"))
	require.Equal(t, "chat.takwen.co/do/subpath", condenseSiteURL("chat.takwen.co/do/subpath"))
	require.Equal(t, "chat.takwen.co/do/subpath", condenseSiteURL("chat.takwen.co/do/subpath/"))

	require.Equal(t, "takwen.co/do:8080", condenseSiteURL("http://takwen.co/do:8080"))
	require.Equal(t, "takwen.co/do:8080", condenseSiteURL("http://takwen.co/do:8080/"))
	require.Equal(t, "chat.takwen.co/do:8080", condenseSiteURL("http://chat.takwen.co/do:8080"))
	require.Equal(t, "chat.takwen.co/do:8080", condenseSiteURL("http://chat.takwen.co/do:8080/"))
	require.Equal(t, "takwen.co/do:8080/subpath", condenseSiteURL("http://takwen.co/do:8080/subpath"))
	require.Equal(t, "takwen.co/do:8080/subpath", condenseSiteURL("http://takwen.co/do:8080/subpath/"))
	require.Equal(t, "chat.takwen.co/do:8080/subpath", condenseSiteURL("http://chat.takwen.co/do:8080/subpath"))
	require.Equal(t, "chat.takwen.co/do:8080/subpath", condenseSiteURL("http://chat.takwen.co/do:8080/subpath/"))
}
