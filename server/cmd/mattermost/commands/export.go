...
var ExportCmd = &cobra.Command{
	...
	Long:  "Export data from TAKWEN DOin a format suitable for import into a third-party application or another TAKWEN DOinstance",
}

var ScheduleExportCmd = &cobra.Command{
	Use:     "schedule",
	Short:   "Schedule an export data job in Mattermost",
	Long:    "Schedule an export data job in TAKWEN DO(this will run asynchronously via a background worker)",
...
var CsvExportCmd = &cobra.Command{
	Use:     "csv",
	Short:   "Export data from TAKWEN DOin CSV format",
	Long:    "Export data from TAKWEN DOin CSV format",
...
var ActianceExportCmd = &cobra.Command{
	Use:     "actiance",
	Short:   "Export data from TAKWEN DOin Actiance format",
	Long:    "Export data from TAKWEN DOin Actiance format",
...
var GlobalRelayZipExportCmd = &cobra.Command{
	...
	Short:   "Export data from TAKWEN DOinto a zip file containing emails to send to Global Relay for debug and testing purposes only.",
	Long:    "Export data from TAKWEN DOinto a zip file containing emails to send to Global Relay for debug and testing purposes only. This does not archive any information in Global Relay.",
...
var BulkExportCmd = &cobra.Command{
	...
	Long:    "Export data to a file compatible with the TAKWEN DOBulk Import format.",
