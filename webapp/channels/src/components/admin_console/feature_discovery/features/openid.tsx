...
const OpenIDFeatureDiscovery: React.FC = () => {
    return (
        <FeatureDiscovery
            ...
            titleDefault='Integrate OpenID Connect with TAKWEN DOProfessional'
            ...
            learnMoreURL='https://docs.takwen.co/do/cloud/cloud-administration/sso-openid-connect.html'
