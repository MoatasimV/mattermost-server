                    ...
                    <IntegrationOption
                        ...
                        description={
                            <FormattedMessage
                                ...
                                defaultMessage='Auth 2.0 allows external applications to make authorized requests to the TAKWEN DOAPI'
                            />
                        }
                ...
                <IntegrationOption
                    ...
                    description={
                        <FormattedMessage
                            ...
                            defaultMessage='Use bot accounts to integrate with TAKWEN DOthrough plugins or the API'
                        />
                    }
