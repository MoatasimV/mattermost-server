            ...
            errorMessage = (
                <div>
                    <FormattedMessage
                        ...
                        defaultMessage='Mattermost was unable to load because a setting in your browser prevents the use of its local storage features. To allow TAKWEN DOto load, try the following actions:'
                    />
                    <ul>
                        <li>
                            <FormattedMessage
                ...
                <div>
                    ...
                    <p>
                        <FormattedMessage
                            ...
                            defaultMessage='For {link} make sure the administrator of your Microsoft organization has enabled the TAKWEN DOapp.'
                            values={{
                                link: (
                                    <ErrorLink
            ...
            errorMessage = (
                <p>
                    <FormattedMessage
                        ...
                        defaultMessage='You must authorize TAKWEN DOto log in with {service}.'
                        values={{
                            service,
                        }}
                    />
