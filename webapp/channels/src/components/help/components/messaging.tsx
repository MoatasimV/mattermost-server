        ...
        <div>
            ...
            <p>
                <FormattedMarkdownMessage
                    ...
                    defaultMessage='**Write Messages:** Use the text input box at the bottom of the TAKWEN DOinterface to write a message. Press **ENTER** to send the message. Use **SHIFT+ENTER** to create a new line without sending a message.'
                />
            </p>
            <p>
                <FormattedMarkdownMessage
