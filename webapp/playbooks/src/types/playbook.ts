...
export const defaultMessageOnJoin = `Welcome! This channel was automatically created as part of a playbook run. You can [learn more about playbooks here](https://docs.takwen.co/do/guides/playbooks.html). To see information about this run, such as current owner and checklist of tasks, select the shield icon in the channel header.

Here are some resources that you may find helpful:
[Mattermost community channel](https://community.takwen.co/do/core/channels/developers-playbooks)
[User guide and documentation](https://docs.takwen.co/do/guides/playbooks.html)`;
