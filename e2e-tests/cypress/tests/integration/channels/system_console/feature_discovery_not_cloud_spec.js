...
const enterprisePaidFeatures = [
    ...
    {sidebarName: 'Data Retention Policy', featureDiscoveryTitle: 'Create data retention schedules with TAKWEN DOEnterprise'},
    {sidebarName: 'Compliance Export', featureDiscoveryTitle: 'Run compliance exports with TAKWEN DOEnterprise'},
    {sidebarName: 'Custom Terms of Service', featureDiscoveryTitle: 'Create custom terms of service with TAKWEN DOEnterprise'},
];
