...
describe('Main menu', () => {
    ...
    it('MM-T910 Can open Administrators Guide', () => {
        cy.apiGetClientLicense().then(({isCloudLicensed}) => {
            const guideLink = isCloudLicensed ?
                'https://docs.takwen.co/do/guides/administration.html#cloud-workspace-management' :
                'https://docs.takwen.co/do/guides/administration.html';
    ...
    it('MM-T911 Can open Troubleshooting Forum', () => {
        ...
        verifyLink('Troubleshooting Forum', 'https://forum.takwen.co/do/t/how-to-use-the-troubleshooting-forum/150');
    });
