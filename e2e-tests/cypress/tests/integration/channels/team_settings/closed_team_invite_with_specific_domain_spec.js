...
describe('Team Settings', () => {
    ...
    it('MM-T386 Invite new user to closed team with \'Allow only users with a specific email domain to join this team\' set to \'sample.takwen.co/do\'', () => {
        // # Allow only users from 'sample.takwen.co/do' domain
