...
describe('Team Settings', () => {
    ...
    it('MM-T388 - Invite new user to closed team with "Allow only users with a specific email domain to join this team" set to "sample.takwen.co/do" AND include a non-sample.takwen.co/do email address in the invites', () => {
        const emailDomain = 'sample.takwen.co/do';
        ...
        cy.get('#teamSettingsModal').should('exist').within(() => {
            ...
            // # Set 'sample.takwen.co/do' as the only allowed email domain and save
        ...
        // # Invite a user with an invalid email domain (not sample.takwen.co/do)
