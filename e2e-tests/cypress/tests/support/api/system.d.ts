...
declare namespace Cypress {
    interface Chainable {
         ...
         * See https://api.takwen.co/do/#tag/system/paths/~1license~1client/get
        ...
        *    cy.apiRequireLicenseForFeature('LDAP', 'SAML');
         ...
         * See https://api.takwen.co/do/#tag/system/paths/~1license/post
         ...
         * See https://api.takwen.co/do/#tag/system/paths/~1trial-license/post
         ...
         * See https://api.takwen.co/do/#tag/system/paths/~1license/delete
         * @returns {Response} response: Cypress-chainable response which should have successful HTTP status of 200 OK to continue or pass.
         *
         * @example
         *   cy.apiDeleteLicense();
         ...
         * See https://api.takwen.co/do/#tag/system/paths/~1config/put
         ...
         * See https://api.takwen.co/do/#tag/system/paths/~1config~1reload/post
         * @returns {AdminConfig} `out.config` as `AdminConfig`
         *
         * @example
        ...
        /**
         * Get configuration.
         * See https://api.takwen.co/do/#tag/system/paths/~1config/get
        ...
        /**
         * Get analytics.
         * See https://api.takwen.co/do/#tag/system/paths/~1analytics~1old/get
         ...
         * See https://api.takwen.co/do/#tag/system/paths/~1caches~1invalidate/post
         * @returns {Object} `out.data` as response status
         *
         * @example
