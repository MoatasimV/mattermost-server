...
declare namespace Cypress {
    interface Chainable {
        ...
        /**
         * Create a bot.
         * See https://api.takwen.co/do/#tag/bots/paths/~1bots/post
        ...
        /**
         * Get bots.
         * See https://api.takwen.co/do/#tag/bots/paths/~1bots/get
        ...
        /**
         * Disable bot.
         * See https://api.takwen.co/do/#tag/bots/operation/DisableBot
