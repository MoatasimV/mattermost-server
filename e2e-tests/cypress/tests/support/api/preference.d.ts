...
declare namespace Cypress {
    interface Chainable {
         ...
         * See https://api.takwen.co/do/#tag/preferences/paths/~1users~1{user_id}~1preferences/put
         ...
         * See https://api.takwen.co/do/#tag/preferences/paths/~1users~1{user_id}~1preferences/get
         * @param {string} userId - User ID
