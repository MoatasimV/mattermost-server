...
declare namespace Cypress {
    interface Chainable {
         ...
         * See https://api.takwen.co/do/#tag/status/paths/~1users~1{user_id}~1status/put
         ...
         * See https://api.takwen.co/do/#tag/status/paths/~1users~1{user_id}~1status/get
         ...
         * See https://api.takwen.co/do/#tag/custom_status/paths/~1users~1{user_id}~1status/custom/put
         ...
         * See https://api.takwen.co/do/#tag/custom_status/paths/~1users~1{user_id}~1status/custom/delete
         * @param {UserCustomStatus} customStatus - custom status to be updated
         *
         * @example
