...
// The plugin package is used by TAKWEN DOserver plugins written in go. It also enables the
// TAKWEN DOserver to manage and interact with the running plugin environment.
//
